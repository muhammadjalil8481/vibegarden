const images = {
  ...
  bearMan: require("../assets/images/bearman.png"),
  jaguarBeing: require("../assets/images/jaguarbeing.png"),
  birdWomen: require("../assets/images/birdwomen.png"),
  dolphinBeing: require("../assets/images/dolphinbeing.png"),
